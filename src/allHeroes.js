export const allHeroes = new Map ([
    ['barbarian', {
        ...
        sArray: [
            ...
            'Shockwave Totem','Spear Trap', 'Subdue', 'Sugar Rush', 'Thunder strike', 
            'Titans Cleaver'
        ],
    }],
    ['pyromancer', {
    ...
    ['houndmaster', {
        ...
        sArray: [
            ...
            'Shrapnel Bomb', 'Shrapnel Shot', 'Spread Shot', 'Storm Of Arrows', 'Suction Bomb',
            'Summon Ballista', 'Surprise Gift', 'Weakening Shot'
        ],
    }],
    ['spellblade', {
        wArray: [
        ...
        sArray: [
            ...
            'Sugar Rush', 'Summon Helper Elves', 'Titans Cleaver'
        ],
    }],
    ['arcaneweaver', {
        wArray: [
        ...
        sArray: [
            ...
            'Summon Chaos Golem', 'Summon Helper Elves'
        ],
    }],
    ['sentinel', {
        wArray: [
        ...
        sArray: [
            ...
            'Shadow orb', 'Shadow Spikes', 'Shrapnel Bomb', 'Spread Shot', 'Storm Of Arrows', 
            'Suction Bomb', 'Summon Ballista', 'Summon Helper Elves', 'Surprise Gift', 'Void'
        ],
    }],
    ['paladin', {
        wArray: [
    ...
    ['chaoswalker', {
        ...
        sArray: [
            ...
            'Pestilence', 'Poison Bolt', 'Poison Cloud', 'Poison Puddle', 'Shadow Bolt', 
            'Shadow orb', 'Shadow Spikes', 'Smite', 'Summon Chaos Golem', 'Void'
        ],
    }],
    ['beastmaster', {
        wArray: [
        ...
        sArray: [
            ...
            'Seismic Shock', 'Shrapnel Bomb', 'Subdue', 'Suction Bomb', 'Surprise Gift',
            'Titans Cleaver'
        ],
    }],
    ['assassin', {
        wArray: [
            ...
            'Debilitating Bomb', 'Fan Of Bombs', 
            'Shadow Stab', 'Reap'
        ],
        sArray: [
            ...
            'Shrapnel Bomb', 'Spear Trap', 'Subdue', 'Suction Bomb', 'Sugar Rush', 
            'Surprise Gift', 'Titans Cleaver', 'Void'
        ],
    }],
    ['elementalist', {
        wArray: [
            ...
            'Ray Of Fire', 'Heat Explosion', 
            'Contaminated Cut', 'Outbreak'
        ],
        sArray: [
            ...
            'Poison Puddle', 'Power Conductor', 'Rolling Boulder', 'Shockwave Totem', 'Summon Helper Elves',
            'Thunder strike'
        ],
    }],
    ['legionnaire', {
        wArray: [
            ...
            'Corrosive Spear', 'Purging Slam', 
            'Piercing Flames', 'Incinerating Spear'
        ],
        sArray: [
            ...
            'Quick Strike', 'Sharp Spear', 'Spear Trap', 'Sugar Rush', 'Summon Chaos Golem', 
            'Thunder strike'
        ],
    }],
    ['necromancer', {
        wArray: [
            ...
            'Summon Plague Rats', 'Putrefy',
            'Murder Of Crows', 'Carrion Crows'
        ],
        sArray: [
    ...
    ['deathknight', {
        wArray: [
            ...
            'Ravaging Strike', 'Carnage', 
            'Frost Strike', 'Glacial Affinity'
        ],
        sArray: [
    ...
    ['monkeyking', {
        wArray: [
            ...
            'Gunpowder Strike', 'Trickster Decoy', 
            'Fracturing Blow', 'Rock Crushing'
        ],
        sArray: [
            ...
            'Shrapnel Bomb', 'Smite', 'Suction Bomb', 'Surprise Gift', 'Thunder strike'
        ],
    }],
    ['engineer', {
        wArray: [
            ...
            'Energizer', 'Power Generator',
            'QT Bombuddy 1000', 'QT Land Surprise'
        ],
        sArray: [
            ...
            'Surprise Gift', 'Thunder strike', 'Weakening Shot' 
        ],
    }],
    ['myrmidon', {
        wArray: [
            ...
            'Sanctified Throw', 'Holy Frenzy',
            'Abyssal Fissure', 'Fury Of The Depths'
        ],
        sArray: [
            ...
            'Rolling Boulder', 'Sharp Spear', 'Shockwave Totem', 'Smite', 'Spear Trap',
